...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_citybranding&task=logs.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_citybranding&view=logs'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="logList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_CITYBRANDING_LOGS_CREATED', 'a.created', $listDirn, $listOrder); ?>
				</th>				
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_CITYBRANDING_LOGS_STEPID', 'a.stepid', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_CITYBRANDING_LOGS_DESCRIPTION', 'a.description', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_CITYBRANDING_LOGS_CREATED_BY', 'a.created_by', $listDirn, $listOrder); ?>
				</th>
