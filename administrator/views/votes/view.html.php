 ...
 */
class CitybrandingViewVotes extends JViewLegacy {
	...
	protected function getSortFields()
	{
		...
		'a.issueid' => JText::_('COM_CITYBRANDING_VOTES_ISSUEID'),
		'a.ordering' => JText::_('JGRID_HEADING_ORDERING'),
		'a.state' => JText::_('JSTATUS'),
		'a.checked_out' => JText::_('COM_CITYBRANDING_VOTES_CHECKED_OUT'),
		'a.checked_out_time' => JText::_('COM_CITYBRANDING_VOTES_CHECKED_OUT_TIME'),
		'a.created_by' => JText::_('COM_CITYBRANDING_VOTES_CREATED_BY'),
		);
	}
