 ...
 * View to edit
 */
class CitybrandingViewStep extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        $canManageSteps = $canDo->get('citybranding.manage.steps');
        if(!$canManageSteps){
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_CITYBRANDING_TITLE_STEP'), 'drawer-2');
