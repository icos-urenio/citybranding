...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_citybranding&task=pois.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'poiList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
		...
		<table class="table table-striped" id="poiList">
			<thead>
				<tr>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_CITYBRANDING_POIS_CREATED', 'a.created', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_CITYBRANDING_POIS_CREATED_BY', 'a.created_by', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'JFIELD_ACCESS_LABEL', 'a.access', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_CITYBRANDING_POIS_LANGUAGE', 'a.language', $listDirn, $listOrder); ?>
				</th>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php if ($canEdit) : ?>
					...
					<?php if($item->moderation) : ?>
						<span class="label label-important"><?php echo JText::_('COM_CITYBRANDING_FORM_LBL_POI_MODERATION'); ?></span>
					<?php endif ?>
