 ...
 * View to edit
 */
class CitybrandingViewIssue extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_CITYBRANDING_TITLE_ISSUE'), 'drawer');
        ...
        if(!empty($this->item->id)) {
            ...
            //JToolBarHelper::custom('issue.printIssue', 'print.png', 'print.png', 'COM_CITYBRANDING_PRINT', false);
            ...
            //$url = 'index.php?option=com_citybranding&amp;view=issue&amp;task=issue.printIssue&amp;id='.$this->item->id.'&amp;tmpl=component';
