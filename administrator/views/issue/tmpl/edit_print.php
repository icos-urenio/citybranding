...
<div class="modal hide fade" id="modal-citybranding-print">
	...
	<div id="section-to-print" class="modal-body">
		...
		<p><?php echo JText::_('COM_CITYBRANDING_FORM_LBL_ISSUE_CREATED_BY'); ?>: 
		<?php 
		...
		<p><strong><?php echo JText::_('COM_CITYBRANDING_FORM_LBL_ISSUE_ID'); ?></strong>: 
		<?php echo $this->item->id; ?>
		</p>
		
		<p><strong><?php echo JText::_('COM_CITYBRANDING_FORM_LBL_ISSUE_STEPID'); ?></strong>: 
		...
		<p><strong><?php echo JText::_('COM_CITYBRANDING_FORM_LBL_ISSUE_CATID'); ?></strong>: 
		<?php echo CitybrandingFrontendHelper::getCategoryNameByCategoryId($this->item->catid); ?></p>
		
		<p><strong><?php echo JText::_('COM_CITYBRANDING_FORM_LBL_ISSUE_ADDRESS'); ?></strong>: 
		<?php echo $this->item->address; ?></p>
		
		<p><strong><?php echo JText::_('COM_CITYBRANDING_FORM_LBL_ISSUE_DESCRIPTION'); ?></strong>: 
