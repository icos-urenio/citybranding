 ...
 */
class CitybrandingViewComments extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        CitybrandingHelper::addSubmenu('comments');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_CITYBRANDING_TITLE_COMMENTS'), 'comments-2');
	...
	protected function getSortFields()
	{
		...
		'a.checked_out_time' => JText::_('COM_CITYBRANDING_COMMENTS_CHECKED_OUT_TIME'),
		'a.created_by' => JText::_('COM_CITYBRANDING_COMMENTS_CREATED_BY'),
		);
	}
