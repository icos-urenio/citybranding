...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_citybranding&task=comments.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_citybranding&view=comments'); ?>" method="post" name="adminForm" id="adminForm">
