 ...
 */
class CitybrandingViewBrands extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        CitybrandingHelper::addSubmenu('brands');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_CITYBRANDING_TITLE_BRANDS'), 'drawer');
        ...
        JHtmlSidebar::setAction('index.php?option=com_citybranding&view=brands');
    ...
    protected function getSortFields()
    {
        ...
        'a.title' => JText::_('COM_CITYBRANDING_BRANDS_TITLE'),
        'a.areaid' => JText::_('COM_CITYBRANDING_BRANDS_AREAID'),
        'a.ordering' => JText::_('JGRID_HEADING_ORDERING'),
        'a.state' => JText::_('JSTATUS'),
        'a.access' => JText::_('JGRID_HEADING_ACCESS'),
        'a.created' => JText::_('COM_CITYBRANDING_BRANDS_CREATED'),
        'a.created_by' => JText::_('COM_CITYBRANDING_BRANDS_CREATED_BY'),
