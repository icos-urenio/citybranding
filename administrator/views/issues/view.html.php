 ...
 */
class CitybrandingViewIssues extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        CitybrandingHelper::addSubmenu('issues');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_CITYBRANDING_TITLE_ISSUES'), 'drawer');
        ...
        JHtmlSidebar::setAction('index.php?option=com_citybranding&view=issues');
    ...
    protected function getSortFields()
    {
        ...
        'a.title' => JText::_('COM_CITYBRANDING_ISSUES_TITLE'),
        'a.stepid' => JText::_('COM_CITYBRANDING_ISSUES_STEPID'),
        'a.catid' => JText::_('COM_CITYBRANDING_ISSUES_CATID'),
        'a.ordering' => JText::_('JGRID_HEADING_ORDERING'),
        'a.state' => JText::_('JSTATUS'),
        'a.access' => JText::_('JGRID_HEADING_ACCESS'),
        'a.created' => JText::_('COM_CITYBRANDING_ISSUES_CREATED'),
        'a.created_by' => JText::_('COM_CITYBRANDING_ISSUES_CREATED_BY'),
