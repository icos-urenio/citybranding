...
class CitybrandingViewBrand extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        print_r($this->state);
        $this->item = $this->getModel('Brand')->getItem($this->state->printid);
        if($this->item->id > 0)
    ...
    protected function addToolbar() {
        ...
        $url = JRoute::_('index.php?option=com_citybranding&view=brand&layout=edit&id='.$this->state->printid, false);
