...
<div class="modal hide fade" id="modal-citybranding-print">
	...
	<div id="section-to-print" class="modal-body">
		...
		<p><?php echo JText::_('COM_CITYBRANDING_FORM_LBL_BRAND_CREATED_BY'); ?>:
		<?php 
		...
		<p><strong><?php echo JText::_('COM_CITYBRANDING_FORM_LBL_BRAND_ID'); ?></strong>:
		<?php echo $this->item->id; ?>
		</p>

		<p><strong><?php echo JText::_('COM_CITYBRANDING_FORM_LBL_BRAND_AREAID'); ?></strong>:
		<?php echo CitybrandingFrontendHelper::getCategoryNameByCategoryId($this->item->catid); ?></p>
		
		<p><strong><?php echo JText::_('COM_CITYBRANDING_FORM_LBL_BRAND_ADDRESS'); ?></strong>:
		<?php echo $this->item->address; ?></p>
		
		<p><strong><?php echo JText::_('COM_CITYBRANDING_FORM_LBL_BRAND_DESCRIPTION'); ?></strong>:
