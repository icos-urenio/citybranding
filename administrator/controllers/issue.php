 ...
 */
class CitybrandingControllerIssue extends JControllerForm
{
    ...
    public function printIssue($pk = null)
    {
        ...
        //$this->setRedirect(JRoute::_('index.php?option=com_citybranding&view=issue&layout=edit&id='.$issueid, false));
    }
    */
