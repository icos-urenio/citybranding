 ...
 */
class CitybrandingModelIssues extends JModelList {
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__citybranding_issues` AS a');
        ...
        //Filtering by category usergroups except if access citybranding.showall.issues = true
...
/*        if (JFactory::getApplication()->isAdmin())
        {
            $user = JFactory::getUser();
            $canShowAllIssues = $user->authorise('citybranding.showall.issues');
            if (!$canShowAllIssues) {
    ...
    public function updateVotes($issueid, $userid) {
        $db = JFactory::getDbo();        
        $query = $db->getQuery(true);
        $query  ->update($db->quoteName('#__citybranding_issues'))
