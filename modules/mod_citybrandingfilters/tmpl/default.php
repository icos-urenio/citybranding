...
<script type="text/javascript">
	...
	js(document).ready(function() {
		...
		js('#apply_filters').click(function(){
			console.log(js('#adminForm').serialize());
			js('#adminForm').submit();
		});
	});
</script>
	...
	<div class="citybranding_filters_buttons">
		<?php if ($option == 'com_citybranding' && $view != 'pois') : ?>
			<span class="citybranding_btn_left">
				<a href="<?php echo JRoute::_('index.php?option=com_citybranding', false, 2); ?>" class="button"><i class="icon-arrow-left"></i> <?php echo JText::_('MOD_CITYBRANDINGFILTERS_RETURN_TO_POIS'); ?></a>
			</span>				
		<?php else : ?>
			<div class="citybranding_btn_left">
				<a id="search_btn" href="#cb-modal" role="button" class="button special cb-modal_open" ><i class="icon-search"></i> <?php echo JText::_('MOD_CITYBRANDINGFILTERS_SEARCH'); ?></a>
<?php /*
				<div class="btn-group">
...
*/ ?>
	...
	<!-- Modal -->
	<div id="cb-modal" tabindex="-1" role="dialog" aria-labelledby="searchModalLabel" aria-hidden="true">
