    ...
    <table class="table table-striped" id="poiList">
        <thead>
            <tr>
                ...
                <?php if ($canEdit || $canDelete): ?>
					<th class="center">
				    <?php echo JText::_('COM_CITYBRANDING_POIS_ACTIONS'); ?>
				</th>
				<?php endif; ?>
        ...
        <tbody>
            ...
            <?php foreach ($this->items as $i => $item) : ?>
				...
				<?php endif; ?>
                <br /><a href="<?php echo JRoute::_('index.php?option=com_citybranding&view=poi&id='.(int) $item->id); ?>"><?php echo JText::_('COM_CITYBRANDING_POIS_MORE');?></a>
				</td>
				<td>
