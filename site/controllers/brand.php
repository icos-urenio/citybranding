 ...
 */
class CitybrandingControllerBrand extends CitybrandingController {
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('Brand', 'CitybrandingModel');
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_citybranding&view=brandform&layout=edit', false));
    }
