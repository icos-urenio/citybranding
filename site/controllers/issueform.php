 ...
 */
class CitybrandingControllerIssueForm extends CitybrandingController {
    ...
    public function edit() {
        ...
        $previousId = (int) $app->getUserState('com_citybranding.edit.issue.id');
        $editId = JFactory::getApplication()->input->getInt('id', null, 'array');

        // Set the user id for the user to edit in the session.
        $app->setUserState('com_citybranding.edit.issue.id', $editId);

        // Get the model.
        $model = $this->getModel('IssueForm', 'CitybrandingModel');
        ...
        $this->setRedirect(JRoute::_('index.php?option=com_citybranding&id=&view=issue&layout=edit', false));
    }
    ...
    public function save() {
        ...
        if ($data === false) {
            ...
            $app->setUserState('com_citybranding.edit.issue.data', $jform, array());

            // Redirect back to the edit screen.
            $id = (int) $app->getUserState('com_citybranding.edit.issue.id');
            $this->setRedirect(JRoute::_('index.php?option=com_citybranding&view=issueform&layout=edit&id=' . $id, false));
            return false;
        }
        ...
        if ($return === false) {
            // Save the data in the session.
            $app->setUserState('com_citybranding.edit.issue.data', $data);
        ...
        $app->setUserState('com_citybranding.edit.issue.id', null);

        // Redirect to the list screen.
        $this->setMessage(JText::_('COM_CITYBRANDING_ITEM_SAVED_SUCCESSFULLY'));
        $menu = JFactory::getApplication()->getMenu();
        $item = $menu->getActive();
        $url = (empty($item->link) ? 'index.php?option=com_citybranding&view=issues' : $item->link);
        $this->setRedirect(JRoute::_($url, false));

        // Flush the data from the session.
        $app->setUserState('com_citybranding.edit.issue.data', null);
    ...
    function cancel() {
        ...
        $editId = (int) $app->getUserState('com_citybranding.edit.issue.id');
    ...
    public function remove() {
        ...
        if ($data === false) {
            ...
            // Redirect back to the edit screen.
            $id = (int) $app->getUserState('com_citybranding.edit.issue.id');
            $this->setRedirect(JRoute::_('index.php?option=com_citybranding&view=issue&layout=edit&id=' . $id, false));
            return false;
        }
    ...
    public function postSaveHook (JModelLegacy $model, $validData = array())
    {
        ...
        if($validData['id'] == 0){
            ...
            if($success){
                ...
                $object->photo = $photo;
                // Update photo
                $result = JFactory::getDbo()->updateObject('#__citybranding_issues', $object, 'id');
