...
/**
	...
	protected function getInput()
	{
		...
		//JFactory::getDocument()->addStyleSheet(JURI::root(true).'/components/com_citybranding/models/fields/step/css/step.css');
		...
		JFactory::getDocument()->addScript(JURI::root(true).'/components/com_citybranding/models/fields/step/js/step.js');		
		...
		$html[] = '<a id="'.$this->type.'_reason_btn" href="#'.$this->type.'Modal" role="button" class="btn btn-mini hide" data-toggle="modal">'.JText::_('COM_CITYBRANDING_JFIELD_STEP_REASON').'</a>';
		...
		$html[] = '				<h3 id="'.$this->type.'ModalLabel">'. ($this->type == 'Cat' ? JText::_('COM_CITYBRANDING_JFIELD_CAT_REASON_DESCRIPTION') : JText::_('COM_CITYBRANDING_JFIELD_STEP_REASON_DESCRIPTION') ) .'</h3>';
		$html[] = '			</div>';
