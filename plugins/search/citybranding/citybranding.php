...
/**
 * @version     1.0.0
 * @package     plg_search_citybranding
...
require_once JPATH_SITE . '/components/com_citybranding/router.php';
 ...
 * @since       1.6
 */
class PlgSearchCitybranding extends JPlugin
{
    ...
    public function onContentSearchAreas() {
        static $areas = array('citybranding' => 'Improve My City');
        return $areas;
    }
